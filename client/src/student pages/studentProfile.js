...
const StudentProfile = () => {
    ...
    const fetchProfileData = async () => {
        try {
            ...
            const response = await fetch(getApiUrl("/api/student-profile"), {
                method: "GET",
                headers: {
    ...
    const addMentor = async (mentorId) => {
        try {
            const token = localStorage.getItem("token");
            const response = await fetch(getApiUrl(`/api/add-mentor/${mentorId}`), {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
                    "Authorization": `Bearer ${token}`,
    ...
    return (
        <div className="container mt-5">
                ...
                <div className="messageMentor">
                    <div className="row">
                        ...
                        <div className="col-lg-4">
                            <Link id='messagebtn' className='btn rounded-5 text-white mt-3 ms-4' to='/editStudentProfile'>Edit Profile</Link>
                        </div>
                    </div>
                </div>
                <div className="messageMentor">
                    <div className="row">
                        ...
                        <div className='col-lg-6'>
                            <h4>View Mentors</h4>
                            <p>You can view all your mentors here</p>
                        </div>
                        <div className="col-lg-4">
            ...
            <Modal show={showModal} onHide={handleCloseModal}>
                ...
                <Modal.Body>
                    {matchingMentors && matchingMentors.length > 0 ? (
