    ...
    useEffect(() => {
        const fetchProfileData = async () => {
            try {
                ...
                const response = await fetch(`http://localhost:3001/api/student-profile-view/${studentId}`, {
                    method: "GET",
                    headers: headers,
                });
                ...
                <div className="messageMentor">
                    <div className="row">
                        ...
                        <div className='col-lg-6'>
                            ...
                            <p>You can communicate with student from here</p>
                        </div>
                        <div className="col-lg-4">
                            <Link id='messagebtn' className='btn rounded-5 text-white mt-3 ms-4' to={`/chat_page?user=${studentId}`}>
                                Message Student
                            </Link>
                        </div>
                    </div>
